    ...
    return (
        <div className={classNames(cls.LoginPage, {}, [className])}>
            <div className={cls.login}>
                <Text text={"Войти в существующий аккаунт"} size={"l"} className={cls.login_text} align={"center"}/>
                <Text text={"или используйте свой эл.адрес"} size={"m"} className={cls.login_small__text}/>
            ...
            <div className={cls.welcome}>
                <div className={cls.welcome_block}>
                    ...
                    <Text text={"Войдите в личный кабинет, указав свою информацию"} className={cls.small_text} align={"center"}/>
                </div>
